      ...
      <tr>
        ...
        <td><input type="texte" class="form-control" id="mark_edit" value="${tabvoiture[index].marquevoiture}"> 
         ...
         <label class="btn btn-outline-primary"> Upload
          <input id='carImg'type="file" value="../../assets/images/${tabvoiture[index].image}" accept="image/*" onchange="preview_image(event)" class="uploadFile img" value="Upload Photo"
...
function modif(id) {
  ...
  todo = {
      ...
      image:document.getElementById('image_edit').files[0].name
